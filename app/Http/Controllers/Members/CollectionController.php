...
class CollectionController extends Controller
{
    ...
    public function categoryBreakdown()
    {
        ...
        return view('members.collection.category-breakdown', $bindings);
    }
    ...
    public function topRatedByCategory($categoryId)
    {
        ...
        return view('members.collection.top-rated-by-category', $bindings);
    }
    ...
    public function showList($listOption)
    {
        ...
        return view('members.collection.list', $bindings);
    }
    ...
    public function add()
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                return redirect(route('members.collection.add'))
    ...
    public function edit($itemId)
    {
        ...
        return view('members.collection.edit', $bindings);
    }
