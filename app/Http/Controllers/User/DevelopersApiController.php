...
class DevelopersApiController extends Controller
{
    ...
    public function guide()
    {
        ...
        return view('user.developers.api.guide', $bindings);
    }
    ...
    public function methods()
    {
        ...
        return view('user.developers.api.methods', $bindings);
    }
    ...
    public function tokens()
    {
        ...
        return view('user.developers.api.tokens', $bindings);
    }
    ...
    public function createToken()
    {
        ...
        return view('user.developers.api.create-token', $bindings);
    }
    ...
    public function deleteToken($tokenId)
    {
        ...
        return view('user.developers.api.delete-token', $bindings);
    }
}
