...
class GameCrawlUrl extends Command
{
    ...
    private function downloadHeaderImage(Game $game, string $remoteUrl, int $remoteSize, $logger): void
    {
        ...
        try {
            ...
            // Under `spaces` any local file is a pre-migration leftover, and removing it here
            // would be an unverified Phase 2 delete by the back door.
            ...
            $this->info("Header image updated ({$newSize} bytes): {$storedFilename}");
