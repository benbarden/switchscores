...
class Crawler
{
    const WIKI_PAGE_ONE = 'https://en.wikipedia.org/wiki/List_of_Nintendo_Switch_games_(A-L)';
    const WIKI_PAGE_TWO = 'https://en.wikipedia.org/wiki/List_of_Nintendo_Switch_games_(M-Z)';
    ...
    public function crawlPageOne()
    {
        $this->domCrawler = $this->goutteClient->request('GET', self::WIKI_PAGE_ONE);
    }

    public function crawlPageTwo()
    {
        $this->domCrawler = $this->goutteClient->request('GET', self::WIKI_PAGE_TWO);
    }
